...
This task ensures that the value directory is present on the ansible container which is refered by `values_dir` variable which is defined at `/platforms/substrate/playbooks/roles/create/helm_component/vars/main.yaml`
##### Input Variables
